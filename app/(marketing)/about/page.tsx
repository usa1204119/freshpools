...
export default function AboutPage() {
  return (
    <>
      ...
      {/* ── Principles ─────────────────────────────────────────────────────── */}
      <section className="section-y border-y border-line-soft wash-soft" aria-labelledby="principles-title">
        <div className="container-x">
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {PRINCIPLES.map((principle, index) => (
              <Block key={principle.heading} color={blockAt(index)} className="h-full p-8">
      ...
      {/* ── Money ──────────────────────────────────────────────────────────── */}
      <section id="fees" className="section-y border-t border-line-soft wash-soft" aria-labelledby="money-title">
        <div className="container-x">
          ...
          <div className="grid gap-5 lg:grid-cols-3">
            {[
              ...
              <Block key={row.who} color={blockAt(index)} className="h-full p-8">
